...
async function runTests() {
    ...
    // T13: Subscription + DataChange (run last as it can affect channel state)
    try {
        ...
        report("T13 Subscription + DataChange", received > 0,
            `${received} notifications`);
    } catch (e) {
        report("T13 Subscription + DataChange", false, e.message);
    }
