...
const debugLog = (0, node_opcua_debug_1.make_debugLog)("DATA_TYPE");
const doDebug = (0, node_opcua_debug_1.checkDebugFlag)("DATA_TYPE");
...
function makeStructureDefinition(baseDataType, defaultEncodingId, fields, isUnion) {
    ...
    const structureType = isUnion
        ?
            (hasSubtypedFields ? node_opcua_types_1.StructureType.UnionWithSubtypedValues : node_opcua_types_1.StructureType.Union)
        : hasOptionalFields
            ? node_opcua_types_1.StructureType.StructureWithOptionalFields
            : (hasSubtypedFields ? node_opcua_types_1.StructureType.StructureWithSubtypedValues : node_opcua_types_1.StructureType.Structure);
    ...
    const isUnionOrStructureWithSubtypedValues = structureType === node_opcua_types_1.StructureType.UnionWithSubtypedValues ||
        structureType === node_opcua_types_1.StructureType.StructureWithSubtypedValues;
