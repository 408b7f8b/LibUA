        ...
        if (references.length >= 1) {
            ...
            if (references.length > 1) {
                if (displayWarning) {
                    ...
                    warningLog("    object node id:", this.nodeId.toString(), chalk_1.default.cyan(this.browseName.toString()));
                    warningLog("    browseResults:");
                    warningLog(references.map((f) => toString_ReferenceDescription(f, options)).join("\n"));
