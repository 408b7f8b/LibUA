...
class MonitoredItem extends events_1.EventEmitter {
    ...
    overflow;
    oldDataValue;
    #monitoringMode = node_opcua_service_subscription_1.MonitoringMode.Invalid;
    ...
    setMonitoringMode(monitoringMode) {
        if (monitoringMode === this.monitoringMode) {
            // nothing to do
            return node_opcua_status_code_1.StatusCodes.BadNothingToDo;
        }
        if (monitoringMode === node_opcua_service_subscription_1.MonitoringMode.Invalid) {
            return node_opcua_status_code_1.StatusCodes.BadInvalidArgument;
        }
        const old_monitoringMode = this.monitoringMode;
        if (monitoringMode === node_opcua_service_subscription_1.MonitoringMode.Disabled) {
        ...
        else if (monitoringMode === node_opcua_service_subscription_1.MonitoringMode.Sampling || monitoringMode === node_opcua_service_subscription_1.MonitoringMode.Reporting) {
            this.#monitoringMode = monitoringMode;
