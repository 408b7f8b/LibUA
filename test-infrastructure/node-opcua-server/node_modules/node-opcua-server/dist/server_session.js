...
class ServerSession extends events_1.EventEmitter {
    ...
    static maxPublishRequestInQueue = 100;
    __status = "new";
    parent;
    authenticationToken;
    nodeId;
    ...
    _watchDog;
    _watchDogData;
    keepAlive = node_opcua_utils_1.WatchDog.emptyKeepAlive;
    _registeredNodesCounter;
    _registeredNodes;
    _registeredNodesInv;
    _cumulatedSubscriptionCount;
    _sessionDiagnostics;
    _sessionSecurityDiagnostics;
    channel_abort_event_handler;
    constructor(parent, userManager, sessionTimeout) {
        ...
        const authenticationTokenBuf = (0, crypto_1.randomBytes)(16);
    ...
    get clientLastContactTime() {
        const lastSeen = this._watchDogData ? this._watchDogData.lastSeen : (0, node_opcua_basic_types_1.getMinOPCUADate)().getTime();
    ...
    async resendMonitoredItemInitialValues() {
