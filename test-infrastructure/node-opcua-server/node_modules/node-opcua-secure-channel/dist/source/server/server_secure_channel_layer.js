...
class ServerSecureChannelLayer extends events_1.EventEmitter {
    ...
    static g_counter = 0;
    #counter = _a.g_counter++;
    #status = "new";
    beforeHandleOpenSecureChannelRequest = async () => { };
     ...
     */
    securityPolicy = security_policy_1.SecurityPolicy.Invalid;
    #parent;
    #protocolVersion;
    #lastTokenId;
    ...
    #messageChunker;
    #timeoutId;
    #open_secure_channel_onceClose = null;
    ...
    #startReceiveTick;
    #endReceiveTick;
    #startSendResponseTick;
    #endSendResponseTick;
    #_bytesRead_before;
    #_bytesWritten_before;
    #_remoteAddress;
    #_remotePort;
    #abort_has_been_called;
    #idVerification;
    #transport_socket_close_listener;
    #tokenStack;
    get status() {
        return this.#status;
    }
    constructor(options) {
        ...
        this.#tokenStack = new token_stack_1.TokenStack(this.channelId);
    ...
    dispose() {
        ...
        (0, node_opcua_assert_1.assert)(!this.#securityTokenTimeout, "_securityTokenTimeout must have been cleared");
        this.#parent = null;
    ...
    init(socket, callback) {
        ...
        this.#transport_socket_close_listener = (err) => {
    ...
    send_response(msgType, response, message, callback) {
        ...
        if (doDebug) {
            ...
            (0, node_opcua_assert_1.assert)(!this.#idVerification[requestId], " response for requestId has already been sent !! - Internal Error");
            this.#idVerification[requestId] = requestId;
        }
        if (utils_1.doPerfMonitoring) {
            // record tick : send response received.
            this.#startSendResponseTick = (0, node_opcua_utils_1.get_clock_tick)();
        }
        ...
        const securityOptions = msgType === "OPN" ? this.#_get_security_options_for_OPN() : this.#_get_security_options_for_MSG(tokenId);
        ...
        if (utils_1.doTraceServerMessage) {
            (0, utils_1.traceResponseMessage)(response, tokenId, channelId, this.#counter);
        }
        ...
        const statusCode = this.#messageChunker.chunkSecureMessage(msgType, options, response, (chunk) => {
            if (chunk) {
                ...
                if (utils_1.doPerfMonitoring) {
                    ...
                    this.#endSendResponseTick = (0, node_opcua_utils_1.get_clock_tick)();
    ...
    getRemoteIPAddress() {
        return this.#transport?._socket?.remoteAddress || "";
    }
    getRemotePort() {
        return this.#transport?._socket?.remotePort || 0;
    }
    getRemoteFamily() {
        return this.#transport?._socket?.remoteFamily || "";
    }
    /**
    ...
    #_build_message_builder() {
        ...
        this.#messageBuilder = new message_builder_1.MessageBuilder(this.#tokenStack.clientKeyProvider(), {
            name: "server",
        ...
        this.#messageBuilder.on("error", (err, statusCode) => {
            ...
            // c8 ignore next
            if (doDebug) {
                debugLog(chalk_1.default.red("Error "), err.message);
    ...
    #_has_endpoint_for_security_mode_and_policy(securityMode, securityPolicy) {
        if (!this.#parent) {
            return true;
        }
    ...
    #_start_security_token_watch_dog(securityToken) {
    ...
    #_prepare_security_token(openSecureChannelRequest, derivedKeys) {
    ...
    #_install_wait_for_open_secure_channel_request_timeout(timeoutFoOpenChannelRequest) {
        // c8 ignore next
        if (doDebug) {
        ...
        (0, node_opcua_assert_1.assert)(!this.#timeoutId, " timeout already started");
        (0, node_opcua_assert_1.assert)(!this.#open_secure_channel_onceClose, " close listener already installed");
        this.#open_secure_channel_onceClose = (err) => {
            // c8 ignore next
            if (doDebug) {
                debugLog("_install_wait_for_open_secure_channel_request_timeout:");
    ...
    #_on_initial_open_secure_channel_request(request, requestId, channelId) {
        debugLog("Just received first OpenSecureChannelRequest");
        this.#status = "connecting";
        /* c8 ignore next */
        if (utils_1.doTraceServerMessage) {
            (0, utils_1.traceRequestMessage)(request, channelId, this.#counter);
        }
        /* c8 ignore next */
        if (!(this.#messageBuilder && this.#messageBuilder.sequenceHeader && this.#messageBuilder.securityHeader)) {
            ...
            return this.#_on_OpenSecureChannelRequestError(node_opcua_status_code_1.StatusCodes.BadCommunicationError, "internal error", { request, requestId, securityHeader });
        }
        const message = {
            request,
            requestId,
        ...
        /* c8 ignore next */
        if (requestId < 0) {
            return this.#_on_OpenSecureChannelRequestError(node_opcua_status_code_1.StatusCodes.BadCommunicationError, "Invalid requestId", message);
        }
        let description = "";
        ...
        if (!(request instanceof services_1.OpenSecureChannelRequest)) {
            ...
            return this.#_on_OpenSecureChannelRequestError(node_opcua_status_code_1.StatusCodes.BadCommunicationError, description, message);
        }
        ...
        if (!hasEndpoint) {
            ...
            return this.#_on_OpenSecureChannelRequestError(node_opcua_status_code_1.StatusCodes.BadSecurityPolicyRejected, description, message);
        }
        this.#messageBuilder
            .on("message", (request, msgType, securityHeader, requestId, channelId) => {
            this.#_on_common_message(request, msgType, securityHeader, requestId, channelId);
        })
            ...
            if (utils_1.doPerfMonitoring) {
                ...
                this.#startReceiveTick = (0, node_opcua_utils_1.get_clock_tick)();
            }
        });
        ...
        this.#_process_certificates(message, (err, statusCode) => {
            ...
            if (err || !statusCode) {
                ...
                return this.#_on_OpenSecureChannelRequestError(statusCode || node_opcua_status_code_1.StatusCodes.BadInternalError, description, message);
            }
            if (statusCode.isNotGood()) {
    ...
    #_wait_for_open_secure_channel_request(timeout) {
        ...
        const messageHandler = (request, msgType, securityHeader, requestId, channelId) => {
            ...
            this.#_on_initial_open_secure_channel_request(request, requestId, channelId);
        };
    ...
    #_get_security_options_for_OPN() {
        ...
        (0, node_opcua_assert_1.assert)(this.#clientPublicKeyLength >= 0);
                ...
                (0, web_1.extractPublicKeyFromCertificate)(clientCertificate, (err, keyPem) => {
                    if (!err) {
                        if (keyPem) {
                            ...
                            this.#clientPublicKey = (0, crypto_1.createPublicKey)(keyPem);
                            this.#clientPublicKeyLength = (0, web_1.rsaLengthPublicKey)(keyPem);
                        }
    ...
    #_prepare_response_security_header(request, message) {
        let securityHeader;
        // senderCertificate:
        ...
        const evaluateReceiverThumbprint = () => {
            ...
            const part1 = (0, web_1.split_der)(this.#clientCertificate)[0];
    ...
    #_check_client_nonce(clientNonce) {
        if (this.securityMode !== node_opcua_service_secure_channel_1.MessageSecurityMode.None) {
            const cryptoFactory = (0, security_policy_1.getCryptoFactory)(this.#messageBuilder.securityPolicy);
            if (!cryptoFactory) {
    ...
    #_make_derivedKeys(serverNonce, clientNonce) {
        if (this.securityMode !== node_opcua_service_secure_channel_1.MessageSecurityMode.None) {
    ...
    #_handle_OpenSecureChannelRequest(messageRequest) {
        this.beforeHandleOpenSecureChannelRequest().then(() => {
            ...
            if (!(requestId !== 0 && requestId > 0)) {
                ...
                return this.#_on_OpenSecureChannelRequestError(node_opcua_transport_1.StatusCodes2.BadTcpInternalError, "invalid request", messageRequest);
            }
            ...
            if (!this.#_check_receiverCertificateThumbprint(messageRequest.securityHeader)) {
                ...
                return this.#_on_OpenSecureChannelRequestError(node_opcua_status_code_1.StatusCodes.BadCertificateInvalid, description, messageRequest);
            }
            const serverNonce = this.#_make_serverNonce();
            const derivedKeys = this.#_make_derivedKeys(serverNonce, request.clientNonce);
            const securityToken = this.#_prepare_security_token(request, derivedKeys);
    ...
    #_on_common_message(request, msgType, securityHeader, requestId, channelId) {
        /* c8 ignore next */
        if (utils_1.doTraceServerMessage) {
            (0, utils_1.traceRequestMessage)(request, channelId, this.#counter);
        }
        ...
        if (msgType === "CLO" /* && request.schema.name === "CloseSecureChannelRequest" */) {
            ...
            if (request.schema.name === "CloseSecureChannelRequest") {
                ...
                if (utils_1.doPerfMonitoring) {
                    ...
                    this.#endReceiveTick = (0, node_opcua_utils_1.get_clock_tick)();
                }
                ...
                if (!securityToken) {
                    ...
                    return this.#_sendFatalErrorAndAbort(node_opcua_status_code_1.StatusCodes.BadCommunicationError, description, message, () => { });
                }
    ...
    // Bad_NonceInvalid
    #_on_OpenSecureChannelRequestError(serviceResult, description, message) {
