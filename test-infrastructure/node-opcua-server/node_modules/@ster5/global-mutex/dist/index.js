...
var NativeLockProvider = class {
  ...
  async isLocked(fileToLock) {
    try {
      await import_node_fs.default.promises.access(lockPath(fileToLock));
      return true;
    } catch {
      return false;
    }
