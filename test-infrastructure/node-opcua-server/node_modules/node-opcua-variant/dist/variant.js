...
exports.VARIANT_TYPE_MASK = exports.VARIANT_ARRAY_DIMENSIONS_MASK = exports.VARIANT_ARRAY_MASK = exports.Variant = exports.VariantArrayType = void 0;
...
class Variant extends node_opcua_factory_1.BaseUAObject {
    static maxTypedArrayLength = 16 * 1024 * 1024;
    static maxArrayLength = 1 * 1024 * 1024;
    static schema = schemaVariant;
    static coerce = _coerceVariant;
...
function isValidScalarVariant(dataType, value) {
    ...
    switch (dataType) {
        ...
        case DataType_enum_1.DataType.String:
            return typeof value === "string" || (0, node_opcua_utils_1.isNullOrUndefined)(value);
        case DataType_enum_1.DataType.Int64:
